...
export default class Navigation extends Component {
  ...
  render() {
    return (
      <div className="Nav-menu flexRow">
        <div className="menuIcons flexRow">
          <Link className="itemIcon" to={"/Dashboard"}>
            <svg
              className="imgSizesvg"
              version="1.0"
...
50 358 55 l321 5 3 148 3 147 -333 -1 c-231 0 -347 -4 -379 -13z"
        ...
        <div className="menuPaleta flexRow">
          <ion-icon class="IconGray2" name="attach"></ion-icon>
          <ion-icon class="IconGray2" name="notifications"></ion-icon>
          <ion-icon
