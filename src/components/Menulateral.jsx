...
const Menulateral = () => {
  ...
  function itemselectedHover(index) {
    if (itemsSelected === index) {
      return "hoverbackSelected";
    } else {
      return "hoverback";
    }
  }
  ...
  return (
    <div className="flexbox iconMenuBox">
      <div className="flexbox flexRow gapp2">
...
50 358 55 l321 5 3 148 3 147 -333 -1 c-231 0 -347 -4 -379 -13z"
          ...
          <Link
            to="/dashboard"
            className={itemselectedHover(0)}
            data-tooltip-id="home-tooltip"
            data-tooltip-content="Inicio"
            onClick={() => handleClick(0)}
          >
            <IonIcon className="fs26" icon={homeOutline} />
          ...
          <Link
            ...
            className={itemselectedHover(1)}
            onClick={() => handleClick(1)}
          >
            <IonIcon className="fs26" icon={bagAddOutline} />
          ...
          <Link
            ...
            data-tooltip-content="Compras"
            className={itemselectedHover(2)}
            onClick={() => handleClick(2)}
          >
            <IonIcon className="fs26" icon={bagRemoveOutline} />
          ...
          <Link
            ...
            className={itemselectedHover(3)}
            onClick={() => handleClick(3)}
          >
            <IonIcon className="fs26" icon={documentTextOutline} />
          ...
          <Link
            ...
            className={itemselectedHover(4)}
            onClick={() => handleClick(4)}
          >
            <IonIcon className="fs26" icon={ticketOutline} />
          ...
          <Link
            ...
            className={itemselectedHover(5)}
            onClick={() => handleClick(5)}
          >
            <IonIcon className="fs26" icon={accessibilityOutline} />
            <Tooltip id="clients-tooltip" />
          </Link>

          <Link
            to="/proveedores"
            data-tooltip-id="provs-tooltip"
            data-tooltip-content="Proveedores"
            className={itemselectedHover(6)}
        ...
        <Link
          to="/sce/configuracion"
          data-tooltip-id="provs-tooltip"
          data-tooltip-content="Configuracion"
          
        >
          <div className={itemselectedHover(7)} onClick={() => handleClick(7)}>
            <IonIcon className="fs26" icon={cogOutline} />
          </div>
